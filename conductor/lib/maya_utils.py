...
def is_arnold_renderer():
    '''
    Return boolean to indicate whether arnold is the current renderer for the maya
    scene
    '''
...
def is_vray_renderer():
    '''
    Return boolean to indicate whether vray is the current renderer for the maya
    scene
    '''
...
def is_renderman_renderer():
    '''
    Return boolean to indicate whether renderman is the current renderer for the maya
    scene
    '''
    return get_current_renderer() in ["renderManRIS", "renderman"]


def is_redshift_renderer():
    '''
    Return boolean to indicate whether redshift is the current renderer for the maya
    scene
    '''
    return get_current_renderer() in ["redshift"]
