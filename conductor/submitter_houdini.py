...
class HoudiniConductorSubmitter(submitter.ConductorSubmitter):
    '''
    ...
    _window_title = "Conductor Submitter: Houdini"

    product = "maya-io"

    def __init__(self, parent=None):
        super(HoudiniConductorSubmitter, self).__init__(parent=parent)
        self.setMayaWindow()
    ...
    def applyDefaultSettings(self):
        super(HoudiniConductorSubmitter, self).applyDefaultSettings()
        #!TODO
...
#         self.setOutputDir(maya_utils.get_image_dirpath())
    ...
    def getEnvironment(self):
        ...
        environment
        '''
        environment = super(HoudiniConductorSubmitter, self).getEnvironment()
        #!TODO
...
#         return maya_utils.MayaInfo.get()
    ...
    def getHostProductInfo(self):
        #!TODO
        host_version = "8888" #maya_utils.MayaInfo.get_version()
...
#             plugins_info.append(plugin_info)
    ...
    def checkSaveBeforeSubmission(self):
        ...
        '''
        #!TODO
        file_unsaved = False #maya_utils.get_maya_save_state()
        if file_unsaved:
...
#             dependencies.update(processed_tx_filepaths)
    ...
    def generateConductorArgs(self, data):
        ...
        conductor_args = super(HoudiniConductorSubmitter, self).generateConductorArgs(data)
    ...
    def runConductorSubmission(self, data):
        ...
        return super(HoudiniConductorSubmitter, self).runConductorSubmission(data)
    ...
    def validateJobPackages(self):
        ...
        '''
        #!TODO
#         is_valid = super(HoudiniConductorSubmitter, self).validateJobPackages()
...
def get_houdini_window():
    ...
    '''
    mainWindowPtr = hou.ui.mainQtWindow()
    return mainWindowPtr #wrapInstance(long(mainWindowPtr), QtWidgets.QMainWindow)
