...
class ConductorSubmitter(QtWidgets.QMainWindow):
    ...
    def populateInstanceTypeCmbx(self):
        """Populate the Instance combobox with all of the available instance
        types."""
    ...
    def setInstanceType(self, core_count):
        ...
        item_idx = self.ui_instance_type_cmbx.findData(
            {"cores": core_count, "flavor": "standard", "description": "16 core, 60.0GB Mem"})
        if item_idx == -1:
