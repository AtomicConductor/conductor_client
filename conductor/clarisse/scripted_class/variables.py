...
to do something a little more advanced, for example create their own
command, they may find them useful. Note, these variables should only be
relied on by ConductorJob nodes, and only during the submission process,
and not by other nodes in Clarisse.
"""
import ix
