...
|Clarisse beta |Centos el7 installer|  [conductor-v2.8.3-0.el7.x86_64.rpm](https://github.com/AtomicConductor/conductor_client/releases/download/v2.8.3/conductor-v2.8.3-0.el7.x86_64.rpm) |
|Clarisse beta |Windows 10 installer|  [conductor-v2.8.3.exe](https://github.com/AtomicConductor/conductor_client/releases/download/v2.8.3/conductor-v2.8.3.exe) |
|Clarisse beta |Mac installer|  [conductor-v2.8.3.pkg](https://github.com/AtomicConductor/conductor_client/releases/download/v2.8.3/conductor-v2.8.3.pkg) |
|Clarisse beta |Manual install|  [v2.8.3.tar.gz](https://github.com/AtomicConductor/conductor_client/archive/v2.8.3.tar.gz) |
