...
The Conductor submitter for Maya allows you to ship renders to Conductor's cloud from a familiar interface within Maya. It is implemented as a custom class that lives inside the project. The class name is ConductorJob.
